...
const InfoContact = () => {
  return (
    <>
      <Head>
        <title>Louez votre logement Airbnb en Touraine (37) - Inbed</title>
        <meta
          name="description"
          content="Inbed gère pour vous votre logement et le met en location en Touraine sur Airbnb ou encore Booking et Abritel. Dégagez facilement des revenus locatifs !"
        />
      </Head>
      <main>
        <div></div>
        ...
        <section className={styles.infoContactIntro}>
            ...
            <div className={styles.left}>
              ...
              <div>
                ...
                <p>
                  ...
                  :{" "}
                  <strong>
                    détails des réservations, nombre de voyageurs, loyers
                    perçus,…
                  </strong>{" "}
          ...
          <a
            href="#anchor-form"
            className={`${styles.infoContactIntroBtn} btn`}
          >
            ...
            <div className={styles.prestationCards}>
              <div className={styles.prestationCard}>
                ...
                <p>
                  ...
                  avec des <strong>prestataires de qualité</strong>. Le ménage
                  est réalisé systématiquement après chaque séjour par notre
                  équipe professionnelle. Inbed, c’est la garantie d’un{" "}
              ...
              <div className={styles.prestationCard}>
                ...
                <p>
                  ...
                  <br /> Nous fournissons l'ensemble du linge de maison pour
              ...
              <div className={styles.prestationCard}>
                ...
                <p>
                  {" "}
                  Notre personnel<strong> Inbed </strong>accompagne les
                  voyageurs tout au long de leur séjour dans votre{" "}
                  <Link href="/contact#form">
                    location Airbnb à Tours et Amboise.
                  </Link>
                  <br />
                  Il nous tient à cœur d'être présent le plus souvent possible
                  en personne (pour leur accueil et leur départ) afin de
                  s’assurer que tout se soit bien passé.
                  <br />
                  Nous fournissons un ensemble de consommables permettant aux
                  voyageurs de{" "}
                  <strong>passer la première nuit l'esprit tranquille</strong>.
                  Chez Inbed, tout est fait pour que vos visiteurs se sentent
                  bien et{" "}
                  <strong>
        ...
        <section className={`${styles.infoContactPrice} container`}>
          ...
          <div>
            ...
            <p id={styles.textCommission}>
              <strong>de commission</strong> sur les loyers perçus + les frais
              de ménage payés par les voyageurs.
            </p>
            <u>Exemple de revenu :</u>
            <p>
              Un voyageur réserve votre logement pour 3 nuits à 100€/nuit soit
              un total de 300€. À ce tarif vont s’ajouter les 50€ de frais de
              ménage.
              <br />
              Vous percevrez 350€ et nous vous adresserons une facture
              comprenant les 50€ de frais de ménage ainsi que les 20% de
              commission sur les 300€.
            </p>
            <p>
