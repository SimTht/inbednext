  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Présentation de la conciergerie et des membres l'équipe"
        />
      </Head>
      <main>
        ...
        <section className={styles.aboutUsMiddle}>
          <div className={`container ${styles.aboutUsMiddleMain}`}>
            <div className={styles.left}>
              ...
              <p>
                Inbed est une agence de conciergerie locale à taille humaine.
                Nos racines tourangelles nous permettent de proposer des
                services de grande qualité aux voyageurs et une réactivité
                inégalée aux propriétaires.
              </p>
              <p>
                Notre but est d'accompagner les propriétaires dans la gestion de
                leurs biens en location saisonnière (Airbnb, Booking.com,
                Abritel) en offrant une solution tout compris.
              </p>
            </div>
